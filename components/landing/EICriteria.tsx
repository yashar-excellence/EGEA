              ...
              >
                ...
                {hoveredEI === criteria.id && (
                  <div className="absolute z-50 bottom-full right-0 mb-3 w-80 pointer-events-none">
                    <div className="bg-slate-900/98 border border-gold-500/40 rounded-2xl p-5 shadow-2xl shadow-black/50 backdrop-blur-xl">
                    ...
                    <div className="w-3 h-3 bg-slate-900/98 border-r border-b border-gold-500/40 rotate-45 absolute -bottom-1.5 right-8" />
                  </div>
                )}
              </div>
            ))}
              ...
              >
                ...
                {hoveredComp === comp.id && (
                  <div className="absolute z-50 bottom-full right-0 mb-3 w-72 pointer-events-none">
                    <div className="bg-slate-900/98 border border-gold-500/30 rounded-2xl p-4 shadow-2xl shadow-black/50 backdrop-blur-xl">
                      <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="w-3 h-3 bg-slate-900/98 border-r border-b border-gold-500/30 rotate-45 absolute -bottom-1.5 right-8" />
                  </div>
                )}
              </div>
            ))}
